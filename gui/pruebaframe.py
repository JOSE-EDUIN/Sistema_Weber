...
class frame_monitoreo (tk.LabelFrame):
    ...
    def gif_error_web(self):
        self.lbl1 = tk.Label(self, text="1. Conexión a la pagina web")
        self.lbl1.grid(row=0,column=0,padx=20, pady=5, sticky=W)
    ...
    def gif_error_bd(self):
        self.lbl1 = Label(self, text="2. Conexión a la base de datos")
        self.lbl1.grid(row = 1, column = 0, padx=20, pady=5, sticky=W)
        fuente=tkFont.Font(family="Arial", size=11)
        self.lbl1.configure(font=fuente)
    ...
    def gif_error_busqueda_publicacion(self):
        self.lbl1 = Label(self, text="3. Buscando publicación nueva")
        self.lbl1.grid(row = 2, column = 0, padx=20, pady=5, sticky=W)
        fuente=tkFont.Font(family="Arial", size=11)
        self.lbl1.configure(font=fuente)
    ...
    def gif_error_extraer_link(self):  
        self.lbl1 = Label(self, text="4. Extrayendo links de publicaciones")
        self.lbl1.grid(row = 3, column = 0, padx=20, pady=5, sticky=W)
        fuente=tkFont.Font(family="Arial", size=11)
        self.lbl1.configure(font=fuente)
    ...
    def gif_error_enviar_link(self):
        self.lbl1 = Label(self, text="5. Enviando links a la base de datos")
        self.lbl1.grid(row = 0, column = 2, padx=20, pady=5, sticky=W)
        fuente=tkFont.Font(family="Arial", size=11)
        self.lbl1.configure(font=fuente)
    ...
    def gif_error_envio_correo(self):
        self.lbl1 = Label(self, text="6. Enviando correo electrónico")
        self.lbl1.grid(row = 1, column = 2, padx=20, pady=5, sticky=W)
        fuente=tkFont.Font(family="Arial", size=11)
        self.lbl1.configure(font=fuente)
    ...
    def gif_error_fin_proceso(self):
        ...
        self.lbl1.grid(row = 2, column = 2, padx=20, pady=5, sticky=W)
        fuente=tkFont.Font(family="Arial", size=11)
        self.lbl1.configure(font=fuente)
