...
class manipulacion_db():
    ...
    def consulta_links(self, lst_nva_pub, cont_link_dominio, lst_link_dominio):
        ...
        self.cont_link_dominio=cont_link_dominio
        self.lst_link_dominio=lst_link_dominio
        # print ("entro en consulta link")
        conexion = conexion_bd()  
        conexion.cursor.execute("SELECT * FROM `extraccion` WHERE link = %s;", (lst_link_dominio[self.cont_link_dominio],))
